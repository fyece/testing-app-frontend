<template>
  <button
    :type="type"
    class="text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center"
    :class="{
      'bg-blue-700 hover:bg-blue-800': color === 'blue',
      'bg-gray-700 hover:bg-gray-800': color === 'gray',
